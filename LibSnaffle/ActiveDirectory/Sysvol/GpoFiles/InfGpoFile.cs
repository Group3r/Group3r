                    ...
                    switch (sectionHeading)
                    {
                        ...
                        case "Registry Keys":
                            ...
                            if (!String.IsNullOrWhiteSpace(splitLine[2].Trim('"')))
                            {
                                ...
                                regKeySetting.ParsedKeySddl = new Sddl.Parser.Sddl(regKeySetting.KeySddlString, SecurableObjectType.RegistryKey);
                            }
                        ...
                        case "Service General Setting":
                            ...
                            if (!String.IsNullOrWhiteSpace(splitLine[2].Trim('"')))
                            {
                                ...
                                // these don't have values, they're just changing acls on keys.
                                serviceSetting.ParsedSddl = new Sddl.Parser.Sddl(serviceSetting.Sddl, SecurableObjectType.WindowsService);
                            }
                        ...
                        case "Version":
                            ...
                            break;
                        default:
                            Logger.Error("Something unexpected or unhandled in an Inf file: ");
                            Logger.Error(sectionHeading);
                            break;
                    }

                    if (lineKey == "")
                    {
                        Logger.Error("Something has gone wrong parsing an Inf file.");
                    }
                }
            }
        }
